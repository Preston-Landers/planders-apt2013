...
public class Streamlist extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetMedia extends StreamlistRequest<com.appspot.connexus_apt.streamlist.model.MediaCollection> {

    private static final String REST_PATH = "mediacollection/{streamId}/{streamOwnerId}/{queryLimit}/{queryOffset}";
    ...
    protected GetMedia(java.lang.Long streamId, java.lang.Long streamOwnerId, java.lang.Integer queryLimit, java.lang.Integer queryOffset) {
      super(Streamlist.this, "GET", REST_PATH, null, com.appspot.connexus_apt.streamlist.model.MediaCollection.class);
   ...
   * @return the request
   */
  public GetUploadUrl getUploadUrl(java.lang.Long streamId, java.lang.Long streamOwnerId) throws java.io.IOException {
    GetUploadUrl result = new GetUploadUrl(streamId, streamOwnerId);
    initialize(result);
    return result;
  }

  public class GetUploadUrl extends StreamlistRequest<com.appspot.connexus_apt.streamlist.model.UploadUrl> {

    private static final String REST_PATH = "uploadurl/{streamId}/{streamOwnerId}";
     ...
     * @since 1.13
     */
    protected GetUploadUrl(java.lang.Long streamId, java.lang.Long streamOwnerId) {
      super(Streamlist.this, "GET", REST_PATH, null, com.appspot.connexus_apt.streamlist.model.UploadUrl.class);
      this.streamId = com.google.api.client.util.Preconditions.checkNotNull(streamId, "Required parameter streamId must be specified.");
      this.streamOwnerId = com.google.api.client.util.Preconditions.checkNotNull(streamOwnerId, "Required parameter streamOwnerId must be specified.");
    }
    ...
    public GetUploadUrl setStreamOwnerId(java.lang.Long streamOwnerId) {
      this.streamOwnerId = streamOwnerId;
      return this;
    }
