...
public class Streamlist extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * This request holds the parameters needed by the streamlist server.  After setting any optional
   * parameters, call the {@link GetNearby#execute()} method to invoke the remote operation.
   *
   * @param queryLimit
   * @param queryOffset
   * @param latitude
   ...
   * @return the request
   */
  public GetNearby getNearby(java.lang.Integer queryLimit, java.lang.Integer queryOffset, java.lang.Double latitude, java.lang.Double longitude) throws java.io.IOException {
    GetNearby result = new GetNearby(queryLimit, queryOffset, latitude, longitude);
    initialize(result);
    return result;
  }

  public class GetNearby extends StreamlistRequest<com.appspot.connexus_apt.streamlist.model.NearbyResult> {

    private static final String REST_PATH = "nearbyresult/{queryLimit}/{queryOffset}/{latitude}/{longitude}";
     ...
     * @since 1.13
     */
    protected GetNearby(java.lang.Integer queryLimit, java.lang.Integer queryOffset, java.lang.Double latitude, java.lang.Double longitude) {
      super(Streamlist.this, "GET", REST_PATH, null, com.appspot.connexus_apt.streamlist.model.NearbyResult.class);
      this.queryLimit = com.google.api.client.util.Preconditions.checkNotNull(queryLimit, "Required parameter queryLimit must be specified.");
      this.queryOffset = com.google.api.client.util.Preconditions.checkNotNull(queryOffset, "Required parameter queryOffset must be specified.");
    ...
    @Override
    public GetNearby setAlt(java.lang.String alt) {
      return (GetNearby) super.setAlt(alt);
    }

    @Override
    public GetNearby setFields(java.lang.String fields) {
      return (GetNearby) super.setFields(fields);
    }

    @Override
    public GetNearby setKey(java.lang.String key) {
      return (GetNearby) super.setKey(key);
    }

    @Override
    public GetNearby setOauthToken(java.lang.String oauthToken) {
      return (GetNearby) super.setOauthToken(oauthToken);
    }

    @Override
    public GetNearby setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetNearby) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetNearby setQuotaUser(java.lang.String quotaUser) {
      return (GetNearby) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetNearby setUserIp(java.lang.String userIp) {
    ...
    public GetNearby setQueryLimit(java.lang.Integer queryLimit) {
      this.queryLimit = queryLimit;
      return this;
    }
    ...
    public GetNearby setQueryOffset(java.lang.Integer queryOffset) {
      this.queryOffset = queryOffset;
      return this;
    }
    ...
    public GetNearby setLatitude(java.lang.Double latitude) {
    ...
    public GetNearby setLongitude(java.lang.Double longitude) {
