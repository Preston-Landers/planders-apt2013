...
window.cx = (function (cx, $, window, undefined) {
    ...
    $(document).ready(function () {
        ...
        window.cx.FBLoginStatusCallback = function FBLoginStatusCallback(response) {
            ...
            if (cx.SocialPageFBReady) {
                cx.SocialPageFBReady();
            }
        }
        ...
        if ((window['USE_FB'] != undefined) && USE_FB) {
            $.getScript('//connect.facebook.net/en_US/all.js', function () {
                FB.init({
                    appId: '213397308840853',
                    channelUrl: '//cee-me.appspot.com/channel.html', // Channel file for x-domain comms
        ...
        // Not currently using tooltips.
        // $("div[data-toggle='tooltip']").tooltip();

        // Activate popover-style tooltip
