...
public class Sync extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public DeleteMessage deleteMessage(java.lang.String key) throws java.io.IOException {
    DeleteMessage result = new DeleteMessage(key);
    initialize(result);
    return result;
  }
  ...
  public class DeleteMessage extends SyncRequest<com.appspot.cee_me.sync.model.Message> {
    ...
    private static final String REST_PATH = "message/{key}";
     ...
     * @since 1.13
     */
    protected DeleteMessage(java.lang.String key) {
   ...
   * @return the request
   */
  public GetMessage getMessage(java.lang.String key) throws java.io.IOException {
    GetMessage result = new GetMessage(key);
    initialize(result);
    return result;
  }
  ...
  public class GetMessage extends SyncRequest<com.appspot.cee_me.sync.model.Message> {
     ...
     * @since 1.13
     */
    protected GetMessage(java.lang.String key) {
   ...
   * @return the request
   */
  public GetMessages getMessages(java.lang.String key) throws java.io.IOException {
    GetMessages result = new GetMessages(key);
    initialize(result);
    return result;
  }
  ...
  public class GetMessages extends SyncRequest<com.appspot.cee_me.sync.model.MessageQuery> {
    ...
    private static final String REST_PATH = "messagequery/{key}";
     ...
     * @since 1.13
     */
    protected GetMessages(java.lang.String key) {
   ...
   * @return the request
   */
  public SetMessageAccepted setMessageAccepted(java.lang.String key) throws java.io.IOException {
    SetMessageAccepted result = new SetMessageAccepted(key);
    initialize(result);
    return result;
  }
  ...
  public class SetMessageAccepted extends SyncRequest<com.appspot.cee_me.sync.model.Message> {
    ...
    private static final String REST_PATH = "setMessageAccepted/{key}";
     ...
     * @since 1.13
     */
    protected SetMessageAccepted(java.lang.String key) {
      super(Sync.this, "POST", REST_PATH, null, com.appspot.cee_me.sync.model.Message.class);
      this.key = com.google.api.client.util.Preconditions.checkNotNull(key, "Required parameter key must be specified.");
    }
