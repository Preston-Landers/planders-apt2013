...
public class Register extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public DeleteRegistration deleteRegistration(java.lang.String key) throws java.io.IOException {
    DeleteRegistration result = new DeleteRegistration(key);
    initialize(result);
    return result;
  }
  ...
  public class DeleteRegistration extends RegisterRequest<Void> {
    ...
    private static final String REST_PATH = "registration/{key}";
     ...
     * @since 1.13
     */
    protected DeleteRegistration(java.lang.String key) {
   ...
   * @return the request
   */
  public GetDevice getDevice(java.lang.String key) throws java.io.IOException {
    GetDevice result = new GetDevice(key);
    initialize(result);
    return result;
  }
  ...
  public class GetDevice extends RegisterRequest<com.appspot.cee_me.register.model.Device> {
    ...
    private static final String REST_PATH = "device/{key}";
     ...
     * @since 1.13
     */
    protected GetDevice(java.lang.String key) {
   ...
   * @return the request
   */
  public UpdateDevice updateDevice(java.lang.String key) throws java.io.IOException {
    UpdateDevice result = new UpdateDevice(key);
    initialize(result);
    return result;
  }
  ...
  public class UpdateDevice extends RegisterRequest<com.appspot.cee_me.register.model.Device> {
     ...
     * @since 1.13
     */
    protected UpdateDevice(java.lang.String key) {
      super(Register.this, "POST", REST_PATH, null, com.appspot.cee_me.register.model.Device.class);
      this.key = com.google.api.client.util.Preconditions.checkNotNull(key, "Required parameter key must be specified.");
    }
